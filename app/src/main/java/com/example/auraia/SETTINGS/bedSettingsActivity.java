...
import com.example.auraia.SETTINGS.AlertReceiver;
import com.example.auraia.SETTINGS.bedtimesReceiver;
import com.example.auraia.SETTINGS.dimmerOffReceiver;
import com.example.auraia.SETTINGS.dimmerReceiver;
import com.example.auraia.SETTINGS.muteOffReceiver;
import com.example.auraia.SETTINGS.muteOnReceiver;
import com.example.auraia.SETTINGS.timePickerFragment;
...
import static com.example.auraia.SETTINGS.settingsActivity.enableNotifs;
...
public class bedSettingsActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener{
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        if (bedClick == true){
            ...
            try {
                ...
                notifsOffTxt.setText("notifications muted - "+ newTimeNotifOff);
            ...
            if (wakeClick == true) {
                ...
                notifsOnTxt.setText("notifications unmuted - "+ newTimeNotifOn);
    ...
    protected void onStart() {
        ...
        onString = bedroom.getString("NOTIFON","notifications unmuted - " );
        offString = bedroom.getString("NOTIFOFF","notifications muted -" );
