...
public class noiseService extends Service{
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        SharedPreferences npref = this.getSharedPreferences(musicActivity.AUDIO, Context.MODE_PRIVATE);
        ...
        musicActivity.mPlay = true;
        musicActivity.play.setImageResource(R.drawable.pausebtn);
    ...
    public void onDestroy() {
        ...
        bgPlayer.stop();
        bgPlayer.release();
        musicActivity.play.setImageResource(R.drawable.playbtn);
        musicActivity.mPlay = false;
        stopForeground(true);
        stopSelf();
    }
